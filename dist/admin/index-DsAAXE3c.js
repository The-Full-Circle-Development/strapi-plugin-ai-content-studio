...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => Promise.resolve().then(() => require("./Chat-CyShWxIl.js")).then((mod) => ({ default: mod.Chat }))
    });
    app.addSettingsLink(
      {
        id: PLUGIN_ID,
      ...
      },
      {
        ...
        Component: () => Promise.resolve().then(() => require("./Settings-CuBeww7X.js")).then((mod) => ({ default: mod.Settings }))
      }
    );
    app.registerPlugin({
      id: PLUGIN_ID,
